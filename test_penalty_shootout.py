...
cases = [
    # (input_pens, regulation, timer, expected_kept, label)
    ((3, 1), (3, 3), "120:00", True,  "valid 3:3 reg + 3:1 pens kept (120:00)"),
    ((3, 1), (3, 2), "120:00", False, "non-draw regulation drops pens"),
    ((3, 3), (1, 1), "120:00", False, "tied shootout drops pens"),
    ((3, None), (1, 1), "120:00", False, "single-value pens drop"),
    ((90, 0), (1, 1), "120:00", False, "timer-shaped pens dropped (out of range)"),
    ((-1, 5), (1, 1), "120:00", False, "negative pens dropped"),
    ((2, 3), (2, 2), "90:00", False, "non-120 timer drops pens"),
    ((2, 3), (2, 2), None, False, "missing timer drops pens"),
    ((4, 5), (0, 0), "120:00", True, "0:0 + 120:00 + pens 4:5 kept"),
]
for (p1, p2), (s1, s2), timer, kept, label in cases:
    p = {
        "score1": s1, "score2": s2,
        "timer": timer,
        "pen1": p1, "pen2": p2,
